...
class JugadorTest {
	 ...
	 * dorsal del jugador, en caso contrario debe asiganr el número pasado como parámetro en el
	 * método.
	 */
	 ...
	 * También debemos probar si el método devuelve true cuando el jugador tiene 2 o más 
	 * tarjetas amarilla o 1 o más tarjetas rojas, ya que en este caso el jugador estaría expulsado
	 * <br><br>
	 * Para ello implementaremos un bucle for que se repita 12 veces para así poder probar todas
	 * las posibles combinaciones de tarjetas amarillas y tarjetas rojas que hay desde 0 a 3 tarjetas
	 * amarillas y desde 0 a 2 tarjetas rojas.
	 ...
	 * 2 o más tarjetas amarillas, 1 o más tarjetas rojas o ambos casos ocurrirían a la vez, por lo
